...
export function AdminStats() {
  ...
  const stats = [
    { title: 'Tổng Doanh Thu', value: formatPrice(totalRevenue), icon: DollarSign, color: 'text-green-600', bg: 'bg-green-50' },
    { title: 'Đơn Hàng', value: totalOrders.toString(), icon: ShoppingBag, color: 'text-blue-600', bg: 'bg-blue-50' },
    { title: 'Sản Phẩm', value: totalProducts.toString(), icon: Package, color: 'text-purple-600', bg: 'bg-purple-50' },
    { title: 'Chờ Xử Lý', value: pendingOrders.toString(), icon: TrendingUp, color: 'text-orange-600', bg: 'bg-orange-50' }
  ];
