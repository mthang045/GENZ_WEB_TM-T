...
export function PaymentResult() {
    ...
    const txnRef = searchParams.get('txnRef'); // Mã đơn hàng của bạn
    const transactionNo = searchParams.get('transactionNo'); // Mã giao dịch VNPay
                    ...
                    <CardContent className="pt-12 pb-12">
                        {paymentStatus === 'success' ? (
                            <>
                                ...
                                <p className="text-gray-600 mb-6">Cảm ơn bạn đã mua hàng tại GENZ Helmets.</p>
                            ...
                            <>
                                ...
                                <p className="text-gray-600 mb-6">Có lỗi xảy ra trong quá trình thanh toán. Vui lòng thử lại.</p>
                        ...
                        <div className="flex gap-4 justify-center mt-8">
                            <Button onClick={() => navigate('/profile')} className="bg-pink-500 hover:bg-pink-600">
                                Xem Đơn Hàng
                            </Button>
